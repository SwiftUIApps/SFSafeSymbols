...
//  
//
//  Created by Imthath M on 16/07/20.
//
...
extension SFSymbol {
    ...
    // this is a priliminary step to check out whether search functionality is useful in any real app
    // in future we can replace this 1500+ array with CoreData Model or something else which will be more efficient
    
    /// an array which is a computed property with strings for all symbols
